...
/*      var html = "<div id='boxes'>" + "<img src = '" + data.items[0].snippet.thumbnails.default.url + "' width = '150' height ='100' style='border:0;' align='left'>";
      ...
      $('.viewing').html(video);
      location.href="music.php?video=" + data.items[0].id.videoID;  */
...
<iframe src="//www.youtube.com/embed/4BtqElO1OX4?start=310&end=320" frameborder="0" width="750" height="563"></iframe>
</body>
</html>
